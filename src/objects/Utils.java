...
{	public Utils() {}
	...
	public static float[] zeroAmbient()  { return (new float [] {0.5f,  0.5f, 0.5f, 1} ); }
	public static float[] zeroDiffuse()  { return (new float [] {0.5f,  0.5f, 0.5f, 1} ); }
	public static float[] zeroSpecular() { return (new float [] {0.5f,  0.5f, 0.5f, 1} ); }
	public static float zeroShininess()  { return 1.0f; }
}